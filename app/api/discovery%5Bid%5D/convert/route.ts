...
export async function POST(
    ...
    try {
        ...
        const result = await db.insert(leads).values({
            businessName: discoveryLead.businessName,
            contactName: discoveryLead.representative || 'Desconocido',
            phone: discoveryLead.phone1,
            email: discoveryLead.email,
            city: discoveryLead.city,
            address: discoveryLead.address,
            businessType: discoveryLead.businessType,
